...
export default defineUserConfig({
  ...
  head: [
    ['meta', { name: 'image', content: 'https://tg.ygjc.cc/assets/og-image.png' }],
    ...
    ['meta', { property: 'og:url', content: 'https://tg.ygjc.cc/' }],
    ...
    ['meta', { property: 'og:image', content: 'https://tg.ygjc.cc/assets/og-image.png' }],
    ['meta', { property: 'og:image:width', content: '1200' }],
    ['meta', { property: 'og:image:height', content: '630' }],
    ['meta', { property: 'og:image:alt', content: '电报宝典 | Telegram电报中文知识库 & 使用指南' }],
    // Twitter Card
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:site', content: '@hasenbalg673018' }],
    ['meta', { name: 'twitter:creator', content: '@hasenbalg673018' }],
    ['meta', { name: 'twitter:title', content: '电报宝典 | Telegram电报中文知识库 & 使用指南' }],
    ['meta', { name: 'twitter:description', content: '小白也能看懂的 Telegram 电报全方位指南，解决汉化、注册、解封等所有难题。' }],
    ['meta', { name: 'twitter:image', content: 'https://tg.ygjc.cc/assets/og-image.png' }],
    ['meta', { name: 'twitter:image:alt', content: '电报宝典 | Telegram电报中文知识库 & 使用指南' }],
[
  'script', 
