...
::: tip 提示
Rose 默认是英文回复。如果你想让 it 尽量“中文”一点，虽然它没有官方中文包，但你可以通过自定义欢迎语和过滤器来实现“伪汉化”体验。
:::
...
- [Miss Rose 高级管理功能](./rose-advanced.md) — 封禁规则、验证码防机器人与白名单
- [群管机器人对比指南](./bot-comparison.md) — 了解 Rose 与 Combot、XiaoYi 等机器人的优缺点及选型建议