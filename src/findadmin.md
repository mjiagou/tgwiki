---
title: Telegram群组管理员查看教程：如何在各客户端找出群主和管理
shortTitle: 找群管理员
description: 在Telegram群里谁是群主？本文总结了在iOS、Android及电脑版客户端中快速查找群组管理员(Admin)和创建者(Owner)的方法。
icon: user-tie
category:
  - 基础教程
tag:
...
# Telegram群组管理员查看教程：如何在各客户端找出群主和管理
